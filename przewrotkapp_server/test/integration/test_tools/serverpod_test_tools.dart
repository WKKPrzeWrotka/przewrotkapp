...
import 'package:przewrotkapp_server/src/generated/gear/gear_pair.dart' as _i4;
import 'package:przewrotkapp_server/src/generated/rental/rental.dart' as _i5;
...
class _GearReadEndpoint {
  ...
  _i3.Future<List<_i4.GearPair>> getAllGear(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        ) as _i3.Future<List<_i4.GearPair>>);
...
class _UserEndpoint {
  ...
  _i3.Future<_i7.UserInfoPublic> getUserInfo(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<_i7.UserInfoPublic>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i8.ExtraUserInfo> getExtraUserInfo(
    _i1.TestSessionBuilder sessionBuilder, [
    int? userId,
  ]) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<_i8.ExtraUserInfo>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
