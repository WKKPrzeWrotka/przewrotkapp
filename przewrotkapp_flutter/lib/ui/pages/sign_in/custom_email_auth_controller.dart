...
import 'extended_user_info.dart';
...
class CustomEmailAuthController {
  ...
  Future<ExtendedUserInfo?> signIn(String email, String password) async {
    try {
      ...
      if (!serverResponse.success ||
        ...
        return ExtendedUserInfo(userInfo: null, failReason: serverResponse.failReason);;
      }
      ...
      return ExtendedUserInfo(userInfo: serverResponse.userInfo, failReason: null);
    } catch (e, stackTrace) {
      return null;
    }
  }
