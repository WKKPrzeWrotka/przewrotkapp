...
class _SignInPageState extends State<SignInPage> {
  ...
  List<Widget> confirmPasswordResetPage() {
    return [
      ...
      TextField(
        ...
        decoration: InputDecoration(hintText: "Kod weryfikacji", helperText: ' ', errorText: _validationCodeIssue),
        onChanged: (_) {
          setState(() {
            _passwordIssue = null;
          });
  ...
  Future<void> _signIn() async {
    ...
    if (result == null || result.failReason != null) {
      var failReasonText = switch (result?.failReason) {
        null => "Wystąpił błąd",
