...
import 'gear_photo.dart' as _i24;
import 'rental/rental.dart' as _i25;
import 'rental/rental_junction.dart' as _i26;
import 'user/extra_user_info.dart' as _i27;
import 'user/favourites.dart' as _i28;
import 'package:przewrotkapp_client/src/protocol/gear/comment.dart' as _i29;
import 'package:przewrotkapp_client/src/protocol/gear/gear.dart' as _i30;
import 'package:przewrotkapp_client/src/protocol/gear/gear_belt.dart' as _i31;
...
import 'package:przewrotkapp_client/src/protocol/gear/gear_floatbag.dart'
    as _i33;
import 'package:przewrotkapp_client/src/protocol/gear/gear_helmet.dart' as _i34;
import 'package:przewrotkapp_client/src/protocol/gear/gear_kayak.dart' as _i35;
import 'package:przewrotkapp_client/src/protocol/gear/gear_paddle.dart' as _i36;
import 'package:przewrotkapp_client/src/protocol/gear/gear_pfd.dart' as _i37;
...
import 'package:przewrotkapp_client/src/protocol/gear/gear_throwbag.dart'
    as _i39;
import 'package:przewrotkapp_client/src/protocol/rental/rental.dart' as _i40;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i24.GearPhoto) {
      return _i24.GearPhoto.fromJson(data) as T;
    }
    if (t == _i25.Rental) {
      return _i25.Rental.fromJson(data) as T;
    }
    if (t == _i26.RentalJunction) {
      return _i26.RentalJunction.fromJson(data) as T;
    }
    if (t == _i27.ExtraUserInfo) {
      return _i27.ExtraUserInfo.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i24.GearPhoto?>()) {
      return (data != null ? _i24.GearPhoto.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i25.Rental?>()) {
      return (data != null ? _i25.Rental.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i26.RentalJunction?>()) {
      return (data != null ? _i26.RentalJunction.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i27.ExtraUserInfo?>()) {
      return (data != null ? _i27.ExtraUserInfo.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i26.RentalJunction>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i26.RentalJunction>(e))
              .toList()
          : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i24.GearPhoto>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i24.GearPhoto>(e)).toList()
          : null) as T;
    }
    if (t == _i1.getType<List<_i26.RentalJunction>?>()) {
      return (data != null
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i24.GearPhoto) {
      return 'GearPhoto';
    }
    if (data is _i25.Rental) {
      return 'Rental';
    }
    if (data is _i26.RentalJunction) {
      return 'RentalJunction';
    }
    if (data is _i27.ExtraUserInfo) {
    ...
    if (data is List<_i29.Comment>) {
      return 'List<Comment>';
    }
    if (data is List<(_i30.Gear, _i31.GearBelt)>) {
      return 'List<(Gear,GearBelt)>';
    }
    if (data is List<(_i30.Gear, _i32.GearClothing)>) {
      return 'List<(Gear,GearClothing)>';
    }
    if (data is List<(_i30.Gear, _i33.GearFloatbag)>) {
      return 'List<(Gear,GearFloatbag)>';
    }
    if (data is List<(_i30.Gear, _i34.GearHelmet)>) {
      return 'List<(Gear,GearHelmet)>';
    }
    if (data is List<(_i30.Gear, _i35.GearKayak)>) {
      return 'List<(Gear,GearKayak)>';
    }
    if (data is List<(_i30.Gear, _i36.GearPaddle)>) {
      return 'List<(Gear,GearPaddle)>';
    }
    if (data is List<(_i30.Gear, _i37.GearPfd)>) {
      return 'List<(Gear,GearPfd)>';
    }
    if (data is List<(_i30.Gear, _i38.GearSpraydeck)>) {
      return 'List<(Gear,GearSpraydeck)>';
    }
    if (data is List<(_i30.Gear, _i39.GearThrowbag)>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'GearPhoto') {
      return deserialize<_i24.GearPhoto>(data['data']);
    }
    if (dataClassName == 'Rental') {
      return deserialize<_i25.Rental>(data['data']);
    }
    if (dataClassName == 'RentalJunction') {
      return deserialize<_i26.RentalJunction>(data['data']);
    }
    if (dataClassName == 'ExtraUserInfo') {
      return deserialize<_i27.ExtraUserInfo>(data['data']);
    }
    ...
    if (dataClassName == 'List<Comment>') {
      return deserialize<List<_i29.Comment>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearBelt)>') {
      return deserialize<List<(_i30.Gear, _i31.GearBelt)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearClothing)>') {
      return deserialize<List<(_i30.Gear, _i32.GearClothing)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearFloatbag)>') {
      return deserialize<List<(_i30.Gear, _i33.GearFloatbag)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearHelmet)>') {
      return deserialize<List<(_i30.Gear, _i34.GearHelmet)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearKayak)>') {
      return deserialize<List<(_i30.Gear, _i35.GearKayak)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearPaddle)>') {
      return deserialize<List<(_i30.Gear, _i36.GearPaddle)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearPfd)>') {
      return deserialize<List<(_i30.Gear, _i37.GearPfd)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearSpraydeck)>') {
      return deserialize<List<(_i30.Gear, _i38.GearSpraydeck)>>(data['data']);
    }
    if (dataClassName == 'List<(Gear,GearThrowbag)>') {
      return deserialize<List<(_i30.Gear, _i39.GearThrowbag)>>(data['data']);
    }
