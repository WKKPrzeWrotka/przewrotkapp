...
class EndpointGearRead extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i3.Gear>> getAllGear() =>
  ...
  _i2.Future<List<_i4.GearBelt>> getAllBelts() =>
      caller.callServerEndpoint<List<_i4.GearBelt>>(
        'gearRead',
        'getAllBelts',
        {},
      );

  _i2.Future<List<_i5.GearClothing>> getAllClothes() =>
      caller.callServerEndpoint<List<_i5.GearClothing>>(
        'gearRead',
        'getAllClothes',
        {},
      );

  _i2.Future<List<_i6.GearFloatbag>> getAllFloatbags() =>
      caller.callServerEndpoint<List<_i6.GearFloatbag>>(
        'gearRead',
        'getAllFloatbags',
        {},
      );

  _i2.Future<List<_i7.GearHelmet>> getAllHelmets() =>
      caller.callServerEndpoint<List<_i7.GearHelmet>>(
        'gearRead',
        'getAllHelmets',
        {},
      );

  _i2.Future<List<_i8.GearKayak>> getAllKayaks() =>
      caller.callServerEndpoint<List<_i8.GearKayak>>(
        'gearRead',
        'getAllKayaks',
        {},
      );

  _i2.Future<List<_i9.GearPaddle>> getAllPaddles() =>
      caller.callServerEndpoint<List<_i9.GearPaddle>>(
        'gearRead',
        'getAllPaddles',
        {},
      );

  _i2.Future<List<_i10.GearPfd>> getAllPfds() =>
      caller.callServerEndpoint<List<_i10.GearPfd>>(
        'gearRead',
        'getAllPfds',
        {},
      );

  _i2.Future<List<_i11.GearSpraydeck>> getAllSpraydecks() =>
      caller.callServerEndpoint<List<_i11.GearSpraydeck>>(
        'gearRead',
        'getAllSpraydecks',
        {},
      );

  _i2.Future<List<_i12.GearThrowbag>> getAllThrowbags() =>
      caller.callServerEndpoint<List<_i12.GearThrowbag>>(
        'gearRead',
        'getAllThrowbags',
        {},
      );
...
class EndpointRental extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i13.Rental>> getAllRentals() =>
